  ...
  <script type="application/ld+json">
{
  ...
  <style>
    ...
    * {
    ...
    .city-card:hover .city-card-links span {
      background: var(--red);
      color: var(--white);
    ...
    @@keyframes pulse {
      ...
      50% {
        box-shadow: 0 4px 40px rgba(37, 211, 102, 0.9), 0 0 0 10px rgba(37, 211, 102, 0.15);
      }
    }
...
<body>
  ...
  <div class="top-bar">
    <div class="container">
      ...
      <div class="contact-info">
        <span>📞 <a
            href="tel:{{ $settings['phone'] ?? '0579796006' }}">{{ $settings['phone'] ?? '0579796006' }}</a></span>
    ...
    <div class="container">
      <div class="header-inner">
        ...
        <div class="header-cta">
          ...
          <a href="https://wa.me/{{ $settings['whatsapp'] ?? '966579796006' }}" class="btn-whatsapp">💬
            <span>واتساب</span></a>
    ...
    <div class="container">
      <div class="hero-content">
        ...
        <div class="hero-btns">
          ...
          <a href="https://wa.me/{{ $settings['whatsapp'] ?? '966579796006' }}" class="btn-secondary">💬 تواصل
            واتساب</a>
        </div>
        <div class="hero-stats">
          ...
          <div class="stat">
            ...
            <div class="label">مدينة نخدمها</div>
          </div>
          <div class="stat">
            <div class="num">100%</div>
            <div class="label">نقل بضمان</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="partner-section"
    style="padding: 40px 0; background: var(--off-white); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border); position: relative; z-index: 10;">
    <div class="container">
      <div
        style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px; text-align: right;">
        <div style="flex: 1; min-width: 280px;">
          <span class="badge"
            style="display: inline-block; background: var(--blue); color: var(--white); padding: 5px 15px; border-radius: 50px; font-size: 12px; font-weight: bold; margin-bottom: 10px;"><i
              class="fas fa-broom"></i> خدمات النظافة</span>
          <h3
            style="font-size: 22px; font-weight: 900; color: var(--blue); margin: 0; font-family: 'Cairo', sans-serif;">
            خدمات التنظيف والنظافة الشاملة</h3>
          <p style="color: var(--gray); margin: 6px 0 0; font-size: 14px; line-height: 1.6;">نوفر لكم خدمات تنظيف
            المنازل، الفلل، الشقق، والمباني بأعلى مستويات الكفاءة والاحترافية</p>
        </div>
        <div>
          <a href="https://rtscllean.com/" target="_blank" rel="noopener noreferrer"
            style="display: inline-flex; align-items: center; gap: 10px; font-weight: bold; text-decoration: none; padding: 14px 28px; border-radius: 50px; background: linear-gradient(135deg, var(--red), var(--red-dark)); color: var(--white); box-shadow: 0 4px 15px rgba(192, 57, 43, 0.3); transition: all 0.3s ease; border: none; font-size: 15px;"
            onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(192, 57, 43, 0.45)';"
            onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(192, 57, 43, 0.3)';">
  ...
  @if(isset($images['video_testimonials']) && $images['video_testimonials']->count() > 0)
    ...
    <section class="video-testimonial-section"
      style="padding: 60px 0; background: var(--off-white); border-bottom: 1px solid var(--border);">
      <div class="container">
        <div class="section-header">
          <span class="section-tag" style="background: linear-gradient(135deg, var(--red), var(--red-dark));">آراء
            مصورة</span>
        ...
        <div class="video-grid"
          style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 25px; margin-top: 30px; max-width: {{ $images['video_testimonials']->count() === 1 ? '600px' : '1000px' }}; margin-left: auto; margin-right: auto;">
          @foreach($images['video_testimonials'] as $video)
            ...
            @endphp
            {{-- Video card --}}
            <div class="tc home-test-video-item-el" onclick="openVid('{{ $encodedUrl }}')"
              style="cursor:pointer; display:block; padding:0; overflow:hidden; position:relative; min-height:340px; width: 100%; background:#080f1e; border-radius:var(--radius); box-shadow:var(--shadow); transition: transform 0.3s ease, box-shadow 0.3s ease;"
              ...
              <video src="{{ $encodedUrl }}#t=0.5" preload="metadata" muted playsinline
                style="width:100%; height:100%; object-fit:cover; position:absolute; inset:0; pointer-events:none;"></video>
              <div
                style="position:absolute; inset:0; background:rgba(8,15,30,0.35); display:flex; align-items:center; justify-content:center;">
                <div
                  style="width:72px; height:72px; border-radius:50%; background:var(--red); display:flex; align-items:center; justify-content:center; color:#fff; font-size:28px; box-shadow:0 0 35px rgba(192,57,43,0.85); transition:transform 0.2s;"
    ...
    <div class="container">
      <div class="section-header">
        <span class="section-tag"
          style="background: rgba(212,160,23,0.3); color: var(--gold-light); border: 1px solid var(--gold);">لماذا
          نحن؟</span>
      ...
      <div class="why-grid">
        <div class="why-card fade-up">
          ...
          <h4>أسعار مناسبة</h4>
          <p>أسعار تنافسية تناسب جميع الميزانيات بدون أي رسوم خفية</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">👷</div>
          <h4>عمالة مدربة</h4>
          <p>فريق محترف مدرب على أعلى مستويات الكفاءة والأمانة</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">📦</div>
          <h4>تغليف آمن</h4>
          <p>مواد تغليف عالية الجودة تحمي أثاثك من الخدوش والكسر</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">🚛</div>
          <h4>سيارات مجهزة</h4>
          <p>أسطول من الشاحنات الحديثة المجهزة لجميع أنواع الأثاث</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">⚡</div>
          <h4>سرعة في التنفيذ</h4>
          <p>ننجز المهمة في الوقت المحدد دون تأخير أو تسويف</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">🗺️</div>
          <h4>نقل داخل وخارج القصيم</h4>
          <p>نغطي القصيم كاملاً وجميع مدن المملكة بكفاءة عالية</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">🛡️</div>
          <h4>ضمان على الخدمة</h4>
          <p>ضمان كامل على سلامة الأثاث من لحظة الاستلام حتى التسليم</p>
        </div>
        <div class="why-card fade-up">
          <div class="why-icon">📞</div>
          <h4>خدمة عملاء سريعة</h4>
          <p>متاحون على مدار الساعة للإجابة على جميع استفساراتك</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="reviews-grid">
        <div class="review-card fade-up">
          ...
          <p class="review-text">خدمة ممتازة جداً، نقلوا عفشي من القصيم الى الرياض بأمان تام ومن غير أي مشاكل. التغليف
            كان نظيف واحترافي والفريق أخذ وقته في التركيب.</p>
          <div class="reviewer">
        ...
        <div class="review-card fade-up">
          <div class="review-stars">⭐⭐⭐⭐⭐</div>
          <p class="review-text">أسعار مناسبة والخدمة فوق التوقعات. التغليف كان ممتاز وما كسرت أي قطعة. أنصح بهم بشدة
            لكل من يريد بالقصيم.</p>
          <div class="reviewer">
        ...
        <div class="review-card fade-up">
          <div class="review-stars">⭐⭐⭐⭐⭐</div>
          <p class="review-text">نقلوا أثاثي من القصيم الى جدة بدون أي مشكلة. الشاحنة كانت كبيرة وناسبت كل العفش.
            التواصل كان سريع وسهل والتسليم في الموعد المحدد.</p>
          <div class="reviewer">
        ...
        <div class="review-card fade-up">
          <div class="review-stars">⭐⭐⭐⭐⭐</div>
          <p class="review-text">جربت شركات كثيرة وهذه المن حيث الأمانة والسرعة والسعر. فريق العمل محترم ومؤدب. الله
            يوفقهم.</p>
          <div class="reviewer">
  ...
  <section class="faq">
    <div class="container">
      ...
      <div class="faq-wrap">
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">ما هي مناطق خدمة نقل العفش من القصيم الى كل مدن المملكة؟ <span
              class="arrow">▶</span></div>
          <div class="faq-a">نخدم القصيم وجميع مدن المملكة العربية السعودية بما فيها الرياض وجدة والدمام ومكة المكرمة
            والمدينة المنورة وحائل والطائف وغيرها من المدن.</div>
        </div>
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">هل تقدمون ضمان على النقل؟ <span class="arrow">▶</span></div>
          <div class="faq-a">نعم، نقدم ضمان كامل على سلامة الأثاث أثناء النقل. نستخدم مواد التغليف للحفاظ على أثاثك من
            أي ضرر.</div>
        </div>
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">كم تستغرق عملية نقل العفش من القصيم الى الرياض؟ <span
              class="arrow">▶</span></div>
          <div class="faq-a">عادةً تستغرق عملية النقل من القصيم الى الرياض يوماً واحداً، تبدأ بالتغليف والتحميل صباحاً
            وتنتهي بالتسليم والتركيب في الرياض مساءً.</div>
        </div>
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">هل تشملون خدمة فك وتركيب غرف النوم؟ <span class="arrow">▶</span>
          </div>
          <div class="faq-a">نعم، لدينا فنيون متخصصون في فك وتركيب جميع أنواع الأثاث بما فيها غرف النوم والمطابخ
            والمجالس والمكاتب.</div>
        </div>
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">كيف أتواصل معكم لطلب الخدمة؟ <span class="arrow">▶</span></div>
          <div class="faq-a">يمكنك التواصل معنا عبر الاتصال المباشر على الرقم 0579796006 أو عبر الواتساب في أي وقت. نحن
            متاحون على مدار الساعة طوال أيام الأسبوع.</div>
        </div>
        <div class="faq-item">
          <div class="faq-q" onclick="toggleFaq(this)">ما هي الأسعار التقريبية لنقل العفش؟ <span class="arrow">▶</span>
          </div>
          <div class="faq-a">تعتمد الأسعار على حجم الأثاث والمسافة. نقدم أسعار تنافسية ومناسبة لجميع الميزانيات. تواصل
            معنا للحصول على عرض سعر مجاني.</div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="logo-text">
            <div class="brand-name" style="color: white; font-size: 20px; font-weight: 900; margin-bottom: 8px;">🚛
              الأسطورة رونق قلب الخليج</div>
          </div>
          <p class="brand-desc">من القصيم إلى جميع مدن المملكة. نقدم خدمات احترافية بأسعار مناسبة مع ضمان سلامة الأثاث
            وراحة البال.</p>
      ...
      <div class="footer-bottom">
        ...
        <p>Designed and Developed by <a href="https://fourthpyramidagcy.com/" target="_blank"
            style="color: var(--gold-light); text-decoration: underline;">Fourth Pyramid Agency</a></p>
      </div>
    </div>
  </footer>
  ...
  <div id="vidModal"
    style="display:none; position:fixed; inset:0; background:rgba(8,15,30,0.92); z-index:99999; align-items:center; justify-content:center; padding:15px; backdrop-filter:blur(10px); transition: opacity 0.3s ease;"
    onclick="if(event.target===this)closeVid()">
    <div class="vmod-in"
      style="position:relative; width:100%; max-width:850px; aspect-ratio:16/9; background:#000; border-radius:16px; overflow:hidden; box-shadow:0 25px 60px rgba(0,0,0,0.7); border:1px solid rgba(255,255,255,0.1);"
      onclick="event.stopPropagation()">
      <button onclick="closeVid()"
        style="position:absolute; top:12px; right:12px; background:rgba(255,255,255,0.15); border:none; color:#fff; font-size:18px; width:38px; height:38px; border-radius:50%; cursor:pointer; display:flex; align-items:center; justify-content:center; z-index:100; transition:all 0.2s;"
