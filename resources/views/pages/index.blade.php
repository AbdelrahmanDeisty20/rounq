...
<meta name="description" content="الأسطورة رونق قلب الخليج - أفضل شركة نقل عفش بالقصيم مع خدمات الفك والتركيب والتغليف والتحميل والتنزيل. نقل عفش من القصيم لجميع مدن المملكة بضمان وأسعار مناسبة.">
<meta name="keywords" content="نقل عفش القصيم, نقل أثاث القصيم, شركة نقل عفش, القصيم الرياض, نقل عفش بالضمان">
<title>الأسطورة رونق قلب الخليج | أفضل شركة نقل عفش بالقصيم</title>
    ...
    <div class="header-inner">
      <a href="/" class="logo">
        ...
        <div class="logo-text">
          ...
          <div class="brand-sub">نقل عفش احترافي من القصيم لجميع مدن المملكة</div>
        </div>
      </a>
      <nav id="mainNav">
        <ul>
  ...
  <div class="container">
    ...
    <div class="reviews-grid">
      <div class="review-card fade-up">
        ...
        <p class="review-text">خدمة ممتازة جداً، نقلوا عفشي من القصيم للرياض بأمان تام ومن غير أي مشاكل. التغليف كان نظيف واحترافي والفريق أخذ وقته في التركيب.</p>
        <div class="reviewer">
          <div class="reviewer-avatar" style="background: var(--blue);">أ</div>
          <div class="reviewer-info">
            <div class="name">أحمد السالم</div>
            <div class="city">نقل من القصيم للرياض</div>
          </div>
        </div>
      </div>
      <div class="review-card fade-up">
      ...
      <div class="review-card fade-up">
        <div class="review-stars">⭐⭐⭐⭐⭐</div>
        <p class="review-text">نقلوا أثاثي من القصيم لجدة بدون أي مشكلة. الشاحنة كانت كبيرة وناسبت كل العفش. التواصل كان سريع وسهل والتسليم في الموعد المحدد.</p>
        <div class="reviewer">
          <div class="reviewer-avatar" style="background: var(--gold);">ف</div>
          <div class="reviewer-info">
            <div class="name">فهد الشمري</div>
            <div class="city">نقل من القصيم لجدة</div>
          </div>
        </div>
      </div>
      <div class="review-card fade-up">
        ...
        <div class="reviewer">
          ...
          <div class="reviewer-info">
            ...
            <div class="city">نقل من القصيم للدمام</div>
          </div>
        </div>
      </div>
    </div>
...
<section class="faq">
  <div class="container">
    ...
    <div class="faq-wrap">
      ...
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">كم تستغرق عملية نقل العفش من القصيم للرياض؟ <span class="arrow">▶</span></div>
        <div class="faq-a">عادةً تستغرق عملية النقل من القصيم للرياض يوماً واحداً، تبدأ بالتغليف والتحميل صباحاً وتنتهي بالتسليم والتركيب في الرياض مساءً.</div>
      </div>
      <div class="faq-item">
